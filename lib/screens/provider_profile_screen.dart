  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snap) {
        ...
        // Elõfizetés státusz chip (provider)
        ...
        if (activeOk) {
          subLabel = "Aktív elõfizetés";
          subColor = Colors.green.shade600;
        } else if (successful >= 1) {
          subLabel = "Lejárt elõfizetés";
          subColor = Colors.orange.shade700;
        } else {
          subLabel = "Ingyenes idõszak";
          subColor = Colors.blueGrey.shade600;
        }

        return Scaffold(
          appBar: AppBar(title: const Text("Szolgáltatói profil · v3.3")),
          body: ListView(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 8,
                children: [
                  _quickButton(context, Icons.map, "Mûködési terület", () {
                  ...
                  _quickButton(context, Icons.workspace_premium, "Elõfizetés", () {
